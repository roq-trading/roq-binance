...
static_assert(Helper{binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__}} == roq::OrderStatus::UNDEFINED);
...
static_assert(Helper{binance::json::OrderType{binance::json::OrderType::UNDEFINED__}} == roq::OrderType::UNDEFINED);
...
static_assert(Helper{binance::json::Side{binance::json::Side::UNDEFINED__}} == roq::Side::UNDEFINED);
...
static_assert(Helper{binance::json::SymbolStatus{binance::json::SymbolStatus::UNDEFINED__}} == roq::TradingStatus::UNDEFINED);
...
static_assert(Helper{binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__}} == roq::TimeInForce::UNDEFINED);
...
constexpr Helper<roq::OrderStatus>::operator std::optional<binance::json::OrderStatus>() const {
  switch (std::get<0>(args_)) {
    ...
    case UNDEFINED:
      return binance::json::OrderStatus::UNDEFINED__;
    case SENT:
      return binance::json::OrderStatus::UNDEFINED__;
    case ACCEPTED:
      return binance::json::OrderStatus::UNDEFINED__;
    ...
    case STOPPED:
      return binance::json::OrderStatus::UNDEFINED__;
    case COMPLETED:
      return binance::json::OrderStatus::UNDEFINED__;  // XXX HANS no enum for COMPLETED ???
    case EXPIRED:
      return binance::json::OrderStatus::UNDEFINED__;
    case CANCELED:
...
static_assert(Helper{roq::OrderStatus::UNDEFINED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::SENT} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::ACCEPTED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::SUSPENDED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::WORKING} == binance::json::OrderStatus{binance::json::OrderStatus::NEW});
static_assert(Helper{roq::OrderStatus::STOPPED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::COMPLETED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
static_assert(Helper{roq::OrderStatus::EXPIRED} == binance::json::OrderStatus{binance::json::OrderStatus::UNDEFINED__});
...
constexpr Helper<roq::OrderType>::operator std::optional<binance::json::OrderType>() const {
  switch (std::get<0>(args_)) {
    ...
    case UNDEFINED:
      return binance::json::OrderType::UNDEFINED__;
    case MARKET:
...
static_assert(Helper{roq::OrderType::UNDEFINED} == binance::json::OrderType{binance::json::OrderType::UNDEFINED__});
...
constexpr Helper<roq::Side>::operator std::optional<binance::json::Side>() const {
  switch (std::get<0>(args_)) {
    using enum roq::Side;
    case UNDEFINED:
      return binance::json::Side::UNDEFINED__;
    case BUY:
...
static_assert(Helper{roq::Side::UNDEFINED} == binance::json::Side{binance::json::Side::UNDEFINED__});
...
constexpr Helper<roq::TimeInForce>::operator std::optional<binance::json::TimeInForce>() const {
  switch (std::get<0>(args_)) {
    ...
    case UNDEFINED:
      return binance::json::TimeInForce::UNDEFINED__;
    case GFD:
      return binance::json::TimeInForce::UNDEFINED__;
    case GTC:
...
static_assert(Helper{roq::TimeInForce::UNDEFINED} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GFD} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GTC} == binance::json::TimeInForce{binance::json::TimeInForce::GTC});
static_assert(Helper{roq::TimeInForce::OPG} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
...
static_assert(Helper{roq::TimeInForce::GTX} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GTD} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::AT_THE_CLOSE} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GOOD_THROUGH_CROSSING} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::AT_CROSSING} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GOOD_FOR_TIME} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GFA} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
static_assert(Helper{roq::TimeInForce::GFM} == binance::json::TimeInForce{binance::json::TimeInForce::UNDEFINED__});
