...
struct UserStreamParser final {
  struct Handler {
    virtual void operator()(
        const OutboundAccountInfo &, const server::TraceInfo &) = 0;
    virtual void operator()(
        const OutboundAccountPosition &, const server::TraceInfo &) = 0;
    virtual void operator()(
        const BalanceUpdate &, const server::TraceInfo &) = 0;
    virtual void operator()(
        const ExecutionReport &, const server::TraceInfo &) = 0;
  };
