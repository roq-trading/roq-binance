...
template <>
struct fmt::formatter<roq::binance::protocol::json::WSAPIRequest> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::binance::protocol::json::WSAPIRequest const &value, format_context &context) const {
