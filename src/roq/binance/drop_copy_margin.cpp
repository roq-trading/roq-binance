...
uint32_t DropCopyMargin::download(DropCopyState state) {
  switch (state) {
...
void DropCopyMargin::operator()(Trace<json::OutboundAccountPosition> const &event) {
...
void DropCopyMargin::operator()(Trace<json::BalanceUpdate> const &event) {
...
void DropCopyMargin::operator()(Trace<json::ExecutionReport> const &event) {
...
void DropCopyMargin::operator()(Trace<json::ListStatus> const &event) {
...
void DropCopyMargin::request_account() {
...
void DropCopyMargin::request_orders() {
...
void DropCopyMargin::request_trades() {
...
void DropCopyMargin::check_response_trades() {
