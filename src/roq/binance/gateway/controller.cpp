...
void Controller::operator()(OrderEntry::ListenKeyUpdate const &listen_key_update) {
...
OrderEntry &Controller::get_order_entry(std::string_view const &account, MarginMode margin_mode) {
