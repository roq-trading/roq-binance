# [roq-binance](https://roq-trading.com/docs/reference/gateways/crypto/roq-binance/)

Roq's Binance gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-binance/).
